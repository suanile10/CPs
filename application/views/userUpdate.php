...
<img src="images/LOGO.jpg.png" id="Image1" alt=""></div>
<div id="wb_CssMenu1" style="position:absolute;left:479px;top:160px;width:744px;height:70px;z-index:22;">
<ul>
...
<label for="" id="Label1" style="position:absolute;left:0px;top:0px;width:84px;height:33px;line-height:33px;z-index:1;">First Name : </label>
...
<input type="text" id="Editbox1" style="position:absolute;left:141px;top:7px;width:188px;height:16px;line-height:16px;z-index:9;" name="txtFname" value="" spellcheck="false">
<input type="text" id="Editbox2" style="position:absolute;left:140px;top:48px;width:188px;height:16px;line-height:16px;z-index:10;" name="txtLname" value="" spellcheck="false">
<input type="text" id="Editbox3" style="position:absolute;left:141px;top:89px;width:188px;height:16px;line-height:16px;z-index:11;" name="txtUsername" value="" spellcheck="false">
<input type="text" id="Editbox4" style="position:absolute;left:140px;top:120px;width:188px;height:16px;line-height:16px;z-index:12;" name="txtEmail" value="" spellcheck="false">
<input type="text" id="Editbox5" style="position:absolute;left:140px;top:202px;width:188px;height:16px;line-height:16px;z-index:13;" name="txtConPwd" value="" spellcheck="false">
<input type="text" id="Editbox6" style="position:absolute;left:140px;top:279px;width:188px;height:16px;line-height:16px;z-index:14;" name="txtAddress" value="" spellcheck="false">
<input type="text" id="Editbox8" style="position:absolute;left:140px;top:236px;width:188px;height:16px;line-height:16px;z-index:15;" name="txtCNum" value="" spellcheck="false">
<input type="text" id="Editbox7" style="position:absolute;left:140px;top:169px;width:188px;height:16px;line-height:16px;z-index:16;" name="txtPwd" value="" spellcheck="false">
<input type="submit" id="Button1" name="btnUpdate" value="Update" style="position:absolute;left:31px;top:345px;width:96px;height:25px;z-index:17;">
<input type="submit" id="Button2" name="btnCancel" value="Cancel" style="position:absolute;left:191px;top:345px;width:96px;height:25px;z-index:18;">
</form>
</div>
<div id="wb_Image2" style="position:absolute;left:441px;top:197px;width:931px;height:490px;z-index:24;">
<img src="images/whitepuppy-5.jpg" id="Image2" alt=""></div>
</body>
</html>