...
<link href="cho base_url();?>assets/css/dashboard.css" rel="stylesheet">
<link href="cho base_url();?>assets/css/userDashboard.css" rel="stylesheet">
</head>
<body>
<div id="wb_Image1" style="position:absolute;left:0px;top:0px;width:246px;height:197px;z-index:2;">
<img src="cho base_url();?>assets/images/LOGO.jpg.png" id="Image1" alt=""></div>
...
<img src="cho base_url();?>assets/images/group.jpg" id="Image2" alt=""></div>
...
<label for="" id="Label2" style="position:absolute;left:602px;top:261px;width:183px;height:62px;line-height:62px;z-index:8;">USer</label>
<div id="wb_CssMenu2" style="position:absolute;left:18px;top:297px;width:336px;height:156px;z-index:9;">
<ul>
<li class="firstmain"><a href="#" target="_self">Update&nbsp;Profile</a>
</li>
<li><a href="#" target="_self">Choose&nbsp;Service</a>
</li>
<li><a href="#" target="_self">View&nbsp;Service</a>
</li>
</ul>
</div>
</body>
