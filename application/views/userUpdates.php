...
<input type="text" id="Editbox1" style="position:absolute;
left:141px;top:7px;width:188px;height:16px;line-height:16px;z-index:8;" name="txtFname" value="<?php echo $udata->first_name;?>" spellcheck="false"> 
<input type="text" id="Editbox2" style="position:absolute;
left:140px;top:48px;width:188px;height:16px;line-height:16px;z-index:9;" name="txtLname" value="<?php echo $udata->last_name;?>" spellcheck="false">
<input type="text" id="Editbox3" style="position:absolute;
left:141px;top:89px;width:188px;height:16px;line-height:16px;z-index:10;" name="txtUsername" value="<?php echo $udata->username;?>" spellcheck="false" readonly="readonly" color::#FF0000; ">
<input type="text" id="Editbox4" style="position:absolute;left:140px;top:120px;width:188px;height:16px;line-height:16px;z-index:11;" name="txtEmail" value="<?php echo $udata->email;?>" spellcheck="false"> 
<input type="text" id="Editbox5" style="position:absolute;
left:141px;top:154px;width:188px;height:16px;line-height:16px;z-index:12;" name="txtPassword" value="<?php echo $udata->password;?>" spellcheck="false"> <input type="text" id="Editbox6" style="position:absolute;
left:140px;top:202px;width:188px;height:16px;line-height:16px;z-index:13;" name="txtCNum" value="<?php echo$udata->contact_number;?>" spellcheck="false"> <input type="text" id="Editbox8" style="position:absolute;
left:140px;top:36px;width:188px;height:16px;line-height:16px;z-index:14;" name="txtAddress" value="<?php echo
$udata->address;?>" spellcheck="false"> 
<input type="submit" id="Button1" name="btnOk" value="Ok" style="position:absolute;left:31px;top:345px;width:96px;height:25px;z-index:16;"> 
<a href="<?php echo base_url('redirect/userDashboard')?>" style="position:absolute;left:191px;top:350px;width:96px;height:25px;z-index:17;"> Cancel </a>
...
<li><a href="<?php echo base_url();?>UserController/logout" target="_self">Contact&nbsp;Us</a>
</li>
</ul>
</div>
